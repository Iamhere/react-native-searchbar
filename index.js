...
export default class Search extends Component {
  static propTypes = {
    ...
    navWrapperCustomStyle: PropTypes.object,
...
render = () => {
  ...
  {this.state.show && (
  <View style={[styles.navWrapper, { backgroundColor,...navWrapperCustomStyle }]}>
    {Platform.OS === 'ios' &&
  ...
  <Item style={{backgroundColor:'#f3f3f5'}}>
    {visibleSearchIcon &&
    <IonicIcon name="ios-search" style={{fontSize:22, color:"rgb(79, 155, 235)",marginLeft:12,marginRight:12}}/>
    }
  <TextInput
